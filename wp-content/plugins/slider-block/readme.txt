...
- To report issue and contribution visit [Github](https://github.com/EssentialBlocks/slider-block).
- If you have any more questions, visit our support on the [Plugin's Forum](https://wordpress.org/support/plugin/slider-block).
...
🧡 LOVED Slider Block Block? Rate us on [WordPress Repository](https://wordpress.org/support/plugin/slider-block/reviews/#new-post)
...
= Old Way: =
1. Upload `slider-block` to the `/wp-content/plugins/` directory
...
* Improved: Image Height Control for 'Image with Content' layouts
* Improved: Controls and structure
